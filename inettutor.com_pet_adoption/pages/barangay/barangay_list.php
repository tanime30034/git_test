                      ...
                      <?php
                        ...
                        while($row = $query->fetch_assoc())
                        {
                          ...
                          "<tr>
                            ...
                            <td>".$row['barangay']."</td>
                            <td>
                              <a href='#edit_".$row['location_id']."' class='btn btn-success btn-sm' data-toggle='modal'>Edit</a>
                              <a href='#delete_".$row['location_id']."' class='btn btn-danger btn-sm' data-toggle='modal'>Delete</a>
                            </td>
                          </tr>";
