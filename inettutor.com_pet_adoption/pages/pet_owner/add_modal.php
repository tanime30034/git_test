                ...
                <div class="modal-body">
                    <div class="row"> <!-- Start row -->
                        ...
                        <div class="col-md-6"> <!-- Second column -->
                            <div class="form-group">
                                <label for="pet_owner_username">Username</label>
                                <input class="form-control" type="text" id="pet_owner_username" name="pet_owner_username" required>
                            </div>
                            <div class="form-group">
                                <label for="pet_owner_password">Password</label>
                                <input class="form-control" type="password" id="pet_owner_password" name="pet_owner_password" required>
                            </div>
                            <div class="form-group">
