                ...
                <div class="table-responsive">
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <?php
                        ...
                        $sql = "SELECT pet_owner_id, pet_owner_name, pet_owner_contact, pet_owner_email, pet_owner_address, pet_owner_profile, pet_owner_username
                                FROM tbl_pet_owner";
                            ...
                            while($row = $query->fetch_assoc()) {
                                echo "<tr>
                                        <td>
                                          ...
                                          <a href='#change_credentials_" . $row['pet_owner_id'] . "' class='btn btn-info btn-sm' data-toggle='modal'>Login Credentials</a>
                                        </td>
